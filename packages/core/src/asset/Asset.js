...
export class Asset {
     ...
     */
    constructor(source, path = null, mime = null, useRoot = false) {
...
export class ScriptAsset extends SourceAsset {
    constructor(source, path = null, hasMap = true, place = RenderEngineContentPlace.AFTER_CONTENT) {
...
export class StyleAsset extends SourceAsset {
    constructor(source, path = null, hasMap = true, place = RenderEngineContentPlace.HEADER) {
        if (!path) {
