import { Request, Response, Application, ServiceContainer } from "../index.js";
export declare type RequestEventListener = (request: Request, response: Response, path: string, partialPath: string | null) => void;
export declare type ServiceType<T extends Service = Service> = new () => T;
export default class Service<SC extends ServiceContainer<any> | null = ServiceContainer> {
     ...
     */
    onRequest(request: Request, response: Response, path: string, partialPath: string | null): void;
    /**
     ...
     */
    protected listenOnFullPath(path: string, useRoot?: boolean): void;
    /**
     ...
     */
    getContainer(): SC | null;
    setContainer(container: SC): void;
    getContainerType(): new () => SC | null;
}
